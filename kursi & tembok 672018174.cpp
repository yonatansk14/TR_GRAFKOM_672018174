...
void tembok(){
    ...
    glVertex3f(-100.1,-30,35);
    glVertex3f(-100.1,30,35);
    glVertex3f(-100.1,30,-50);
    glVertex3f(-100.1,-30,-50);
    glEnd();
    
    glBegin(GL_POLYGON);
	glColor3f(0.5,0.5,0.5);
    glVertex3f(-107.1,-30,35);
    glVertex3f(-107.1,30,35);
    glVertex3f(-107.1,30,-50);
    glVertex3f(-107.1,-30,-50);
    glEnd();
    
    //tembok luar kiri ke depan
    glBegin(GL_POLYGON);
	glColor3f(0.5,0.5,0.5);
    glVertex3f(-100.1,-30,35);
    glVertex3f(-100.1,30,35);
    glVertex3f(-65,30,84.1);
    glVertex3f(-65,-30,84.1);
    glEnd();
    ...
    glBegin(GL_POLYGON);
	glColor3f(0,0,0);
    glVertex3f(-100.09,-30,35);
    glVertex3f(-100.09,0,35);
    glVertex3f(-65,0,84.09);
    glVertex3f(-65,-30,84.09);
    glEnd();
    
    //tembok luar kiri ke belakang
    glBegin(GL_POLYGON);
	glColor3f(0.5,0.5,0.5);
    glVertex3f(-100.1,-30,-50);
    glVertex3f(-100.1,30,-50);
    glVertex3f(-65,30,-99.1);
    glVertex3f(-65,-30,-99.1);
    glEnd();
    ...
    glBegin(GL_POLYGON);
	glColor3f(0,0,0);
    glVertex3f(-100.09,-30,-50);
    glVertex3f(-100.09,0,-50);
    glVertex3f(-65,0,-99.09);
    glVertex3f(-65,-30,-99.09);
    glEnd();
    ...
    glBegin(GL_POLYGON);
	glColor3f(0,0,0);
    glVertex3f(-20,-30,92.2);
    glVertex3f(-20,0,92.2);
    glVertex3f(20,0,92.2);
    glVertex3f(20,-30,92.2);
    glEnd();
